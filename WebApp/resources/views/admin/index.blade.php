...
<head>
    ...
    <title>Administrator | Upravljačka ploča</title>
            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="/admin"><i class="fa fa-circle-o"></i> Profil</a></li>
                            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Projekti</a></li>
                            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Korisnici</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <li><a href="#"><i class="fa fa-book"></i> <span>Dokumentacija</span></a></li>
                              ...
                              <table class="table table-borderless text-center" id="table">
                                ...
                                @foreach($projects as $project)
                                  <tr class="item{{$project->id}}">
                                    ...
                                    <td>
                                    <button class="edit-modal btn btn-warning" data-id="{{$project->id}}" data-title="{{$project->title}}" data-description="{{$project->description}}" data-mentor="{{$project->mentor}}" data-size="{{$project->size}}" data-team="{{$project->team}}" data-taken="{{$project->taken}}">
